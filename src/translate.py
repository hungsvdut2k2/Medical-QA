...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input-file-path", type=str, required=True, help="Your input dataset file path, can be in huggingface"
    )
    ...
    parser.add_argument(
        "--dest-language", type=str, required=True, help="The destination language of your using dataset"
    )
    ...
    provider = factory.get_provider(
        ...
        dataset_path=arguments.input_file_path,
